...
void InputMgr::update(Real delta)
{
	if(mListener)
		mListener->update();
}
...
String InputMgr::getName()
{
	return String("InputMgr");
}
//-----------------------------------------------------------------------
...
bool InputMgr::isKeyDown(String key)
{
...
bool InputMgr::wasKeyPressed(String key)
{
...
bool InputMgr::isButtonDown(String button)
{
...
bool InputMgr::wasButtonPressed(String button)
{
	return wasButtonPressed(mButtonNames[button]);
}
//-----------------------------------------------------------------------

void InputMgr::initInput(size_t handle, bool grabMouse = false)
{
	mHandle = handle;
...
void InputMgr::_setMousePos(int x,int y, int relx, int rely)
{
...
void InputMgr::assignConversions()
{
